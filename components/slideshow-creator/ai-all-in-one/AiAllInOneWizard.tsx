            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="text-center py-12">
                ...
                <p className="text-lg text-gray-600 mb-6 max-w-md mx-auto">
                  Our AI-powered slideshow generator is currently in
                  development. We're working hard to bring you the most advanced
                  restaurant display technology.
                </p>
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4 border border-purple-200">
                  <p className="text-sm text-purple-700">
                    <strong>What's coming:</strong> One prompt → Complete
                    slideshow with cultural facts, menu items, special offers,
