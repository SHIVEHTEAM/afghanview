...
-- This schema supports AI-generated facts, automatic slide creation, and scheduled content generation
...
ALTER TABLE slides ADD COLUMN IF NOT EXISTS background_music_url TEXT;
ALTER TABLE slides ADD COLUMN IF NOT EXISTS is_auto_generated BOOLEAN DEFAULT false;
ALTER TABLE slides ADD COLUMN IF NOT EXISTS auto_generation_source VARCHAR(50);
